...
fun ToViewClearDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                when (kind) {
                    ToViewClear.Finished -> stringResource(R.string.toview_clear_finished_confirm, finishedCount)
                    ToViewClear.Invalid -> stringResource(R.string.toview_clear_invalid_confirm)
                },
            )
        },
        confirmButton = {
