...
/**
 * 加载 / 出错 / 空 / 到底 —— 四个列表页以前各写了一份,文案和间距都差一点。
 * 收敛到这里,顺带把两条规矩固定下来:
 *
 * - **首屏和翻页用不同的粗细。** 首屏转圈是"这一屏还没有内容",占整屏;
 *   翻页转圈是"下面还有",只占一行的高度。以前两处用的是同一个尺寸,
 *   翻页时那个大圈看起来像整页重载了。
 * - **"没有更多了"永远显示。** 这是 DESIGN 1.1 反变比率奖励那一栏的落点:
 *   有限集合刷得完,刷完了就要明确说完了,不能留一个永远转下去的 footer 让人以为还有。
 */
