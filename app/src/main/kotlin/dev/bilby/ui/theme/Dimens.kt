...
object Dimens {
    /**
     * 列表行里封面的宽度。16:9 下高约 79dp,加上下 8dp 内边距,一行 95dp ——
     * 一屏能露出 7 行左右,既扫得快又不至于把标题压成一行。
     *
     * 360dp 宽的屏上剩给文字的是 360 − 16×2 − 140 − 12 = 176dp,16sp 汉字刚好 11 个字一行,
     * 两行 22 字。B 站标题中位数在这个量级,再窄就得频繁截断。
     */
    val ListCoverWidth = 140.dp
