...
enum class ThemePalette(
    ...
    Default(Color(0xFF4A5C92), Res.string.theme_palette_default),
    Kurenai(Color(0xFFCB1B45), Res.string.theme_palette_kurenai),
    Kanzo(Color(0xFFFC9F4D), Res.string.theme_palette_kanzo),
    Yamabuki(Color(0xFFFFB11B), Res.string.theme_palette_yamabuki),
    Moegi(Color(0xFF7BA23F), Res.string.theme_palette_moegi),
    Wakatake(Color(0xFF5DAC81), Res.string.theme_palette_wakatake),
    Asagi(Color(0xFF33A6B8), Res.string.theme_palette_asagi),
    Kikyo(Color(0xFF6A4C9C), Res.string.theme_palette_kikyo),
    Botan(Color(0xFFC1328E), Res.string.theme_palette_botan),
    ;
