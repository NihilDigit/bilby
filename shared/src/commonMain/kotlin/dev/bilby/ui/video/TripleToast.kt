...
fun TripleToast(outcome: TripleOutcome?, modifier: Modifier = Modifier) {
    ...
    val separator = stringResource(Res.string.video_triple_separator)
    val allLabel = stringResource(Res.string.video_triple_all)
    val noneLabel = stringResource(Res.string.video_triple_none)
    val someFormat = stringResource(Res.string.video_triple_some)
    val likeLabel = stringResource(Res.string.video_action_like)
    val coinLabel = stringResource(Res.string.video_action_coin)
    val favLabel = stringResource(Res.string.video_action_favorite)
