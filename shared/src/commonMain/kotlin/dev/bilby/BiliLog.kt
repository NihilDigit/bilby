...
object BiliLog {
    ...
    fun w(message: String) {
        PlatformLog.w(TAG, message, null)
    }
    ...
    fun w(message: String, throwable: Throwable) {
        PlatformLog.w(TAG, "$message: ${throwable.describe()}", throwable)
    }

    fun e(message: String, throwable: Throwable? = null) {
        PlatformLog.e(TAG, throwable?.let { "$message: ${it.describe()}" } ?: message, throwable)
    }
    ...
    fun d(message: String) {
        if (AppBuild.debug) PlatformLog.d(TAG, message)
    }
}
