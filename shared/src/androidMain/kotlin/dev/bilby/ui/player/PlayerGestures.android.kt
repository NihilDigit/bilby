 ...
 * 视频,不是为了改设备。
 */
internal class WindowBrightness(private val window: Window?) : LevelControl {
...
internal class MediaVolume(context: Context) : LevelControl {
...
@Composable
internal actual fun rememberWindowBrightness(): LevelControl? {
