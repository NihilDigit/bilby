...
fun FavFolderTopBar(
        ...
        title = {
            if (searching) {
                SearchField(
                    ...
                    placeholder = stringResource(R.string.fav_search_hint),
                    onSearch = onSearch,
        ...
        actions = {
            if (searching) {
                IconButton(
                    ...
                    Icon(Icons.Outlined.Close, contentDescription = stringResource(R.string.fav_search_close))
                }
            } else {
                IconButton(onClick = { searchOpen = true }) {
                    Icon(Icons.Outlined.Search, contentDescription = stringResource(R.string.fav_search))
                }
                FolderMenu(
                    folder = folder,
                    cleaning = cleaning,
    ...
    if (confirmingClean) {
        AlertDialog(
            ...
            title = { Text(stringResource(R.string.fav_clean_invalid_confirm)) },
            confirmButton = {
                TextButton(
                    onClick = {
            ...
            dismissButton = {
                TextButton(onClick = { confirmingClean = false }) { Text(stringResource(R.string.action_cancel)) }
            },
        )
    }
}
    ...
    Box {
        IconButton(onClick = { open = true }, enabled = folder != null) {
            Icon(
                ...
                contentDescription = stringResource(R.string.fav_folder_actions, folder?.title.orEmpty()),
            )
        }
        DropdownMenu(
            expanded = open,
            ...
            DropdownMenuItem(
                text = { Text(stringResource(R.string.fav_clean_invalid)) },
                onClick = {
                    open = false
                    onCleanInvalid()
                },
