...
fun BiliResult<*>.errorTextRes(where: String): Int = when (this) {
    ...
    is BiliResult.ApiError -> {
        ...
        if (code == CODE_NOT_LOGGED_IN) R.string.error_login_expired else R.string.error_refused
    }
 ...
 */
@StringRes
fun errorTextResFor(cause: Throwable): Int =
    if (cause is IOException) R.string.error_network else R.string.error_refused
